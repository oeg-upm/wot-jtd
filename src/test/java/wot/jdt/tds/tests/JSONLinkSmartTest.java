...
/**
 * These tests read the TDs provided by LinkSmart. Each test parses from a file a {@link JsonObject}, then such JSON is parsed as a {@link Thing}, finally the original {@link JsonObject} is compared with the {@link Thing} translated into a {@link JsonObject}.
 * The test prove that any JSON-LD framed parsed into a Thing can be translated back. 
 * @author Andrea Cimmino
 *
 */
public class JSONLinkSmartTest {
	...
	private boolean performGenericTest(String file) throws JsonProcessingException {
		...
		return thing != null && JsonHandler.compareJson(thing.toJson(), td);
	}
	...
	public void test0() throws JsonProcessingException {
		Boolean testResult = performGenericTest("./src/test/resources/linksmart/framed/td-0.json");
	...
	public void test24() throws JsonProcessingException {
		 Boolean testResult = performGenericTest("./src/test/resources/linksmart/framed/td-24.json");
		Assert.assertTrue(testResult);
	}
	...
	public void test55() throws JsonProcessingException {
		Boolean testResult = performGenericTest("./src/test/resources/linksmart/framed/td-55.json");
		Assert.assertTrue(testResult);
	}
	...
	public void test60() throws JsonProcessingException {
		Boolean testResult = performGenericTest("./src/test/resources/linksmart/framed/td-60.json");
		Assert.assertTrue(testResult);
	}
